...
public class update_profile_pic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        closeButton = findViewById(R.id.btn_cancel);
        saveButton = findViewById(R.id.btnsave);
        profileChangeBtn = (TextView)findViewById(R.id.change_profile_btn);
        closeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(update_profile_pic.this,Profile_sec.class));
            }
        });
        ...
        profileChangeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CropImage.activity().setAspectRatio(1,1).start(update_profile_pic.this);
            }
        });
        getUserinfo();
    }
